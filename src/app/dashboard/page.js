...
export default function DashboardPage() {
  ...
  return (
    <div className="bg-white min-h-screen">
      <Navbar />
      <main>
        <div className="flex flex-col bg-gray-100 p-2 md:p-10 mx-5 md:flex-row gap-8">
          {/* Left: User Info */}
          <div className="flex-1">
            ...
            {userProfile ? (
              <div className="space-y-3 bg-white rounded-lg p-6 shadow mb-6">
                ...
                <div className="text-lg">
                  ...
                  <span className="text-gray-700">{formatDate(userProfile.created_at)}</span>
                </div>
              </div>
            ) : (
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <button
                ...
                className="flex-1 px-6 py-2 border border-blue-700 text-gray-800 hover:bg-blue-700 hover:text-white rounded font-bold text-lg transition"
              >
                Liked Items
              </button>
              <button
                onClick={handleLogout}
                className="flex-1 px-6 py-2 bg-red-500 border border-red-700 hover:border-red-900 hover:bg-gray-100 hover:text-red-800 text-white rounded font-bold text-lg transition"
              >
                Logout
              </button>
            </div>
