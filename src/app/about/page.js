...
export default function AboutPage() {
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      <Navbar />
      <main className="flex-grow max-w-6xl mx-auto px-4 py-12 space-y-20">
        ...
        <section className="flex flex-col md:flex-row items-center md:items-start gap-8">
          ...
          <div className="md:w-1/2">
            <h2 className="text-3xl font-extrabold text-blue-700 mb-4">What is Luxora</h2>
        ...
        <section className="flex flex-col md:flex-row-reverse items-center md:items-start gap-8">
          ...
          <div className="md:w-1/2">
            <h2 className="text-3xl font-extrabold text-blue-700 mb-4">Why Luxora</h2>
            <p className="text-gray-700 text-lg leading-relaxed">
        ...
        <section className="flex flex-col md:flex-row items-center md:items-start gap-8">
          ...
          <div className="md:w-1/2">
            <h2 className="text-3xl font-extrabold text-blue-700 mb-4">How it was made</h2>
            <p className="text-gray-700 text-lg leading-relaxed">
